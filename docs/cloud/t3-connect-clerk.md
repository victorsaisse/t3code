...
T3CODE_PORT=13773 \
  "/Applications/Flashloop Code (Alpha).app/Contents/MacOS/Flashloop Code (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Flashloop Code (Alpha).app"
codesign -d --entitlements :- "/Applications/Flashloop Code (Alpha).app"
```
